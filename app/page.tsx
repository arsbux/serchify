...
export default function PublicSiteAuditorPage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <NextImage
              ...
              width={40}
              height={40}
              className="rounded-xl shadow-md shadow-blue-500/30"
            />
            <div>
              <h1 className="text-xl font-bold text-gray-900">Serchify</h1>
              <p className="text-xs text-gray-500">Free SEO Audit Tool</p>
            </div>
          </div>
          <Link
            href="/login"
            className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-medium rounded-xl shadow-md shadow-blue-500/25 hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-200"
          >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="px-6 py-12 text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-3">Free SEO Site Auditor</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Scan any e-commerce website for technical SEO issues and get actionable recommendations. No sign-up required.
          </p>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className={`flex items-center gap-0 bg-white border-2 rounded-full shadow-sm transition-all ${
              ...
              <input
                ...
                className="flex-1 px-6 py-4 text-base bg-transparent border-none outline-none rounded-l-full placeholder:text-gray-400"
              />
              <button
                onClick={handleAudit}
                disabled={loading || !url.trim()}
                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed text-white font-medium text-base rounded-full transition-all shadow-md shadow-blue-500/25"
              >
        ...
        {auditReport && !loading && (
          <div className="px-6 py-8 bg-gradient-to-b from-white to-gray-50">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="mb-8">
                <Card className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 mb-2">Want More SEO Tools?</h3>
                      <p className="text-sm text-gray-600">
                        Sign up for free to access AI-powered content optimization, schema generation, keyword research, and more.
                      </p>
                    </div>
                    <Link
                      href="/login"
                      className="ml-6 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-xl transition-all shadow-md shadow-blue-500/25 flex items-center gap-2 whitespace-nowrap"
                    >
                      Sign Up Free
              ...
              {/* Discovered Products Section - Show but link to signup */}
                  ...
                  <Card className="p-8 bg-white border-2 border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {(showAllProducts ? auditMetadata.products : auditMetadata.products.slice(0, 6)).map((product: any, idx: number) => (
                        ...
                        >
                          <Card className="overflow-hidden border-2 border-gray-200 hover:shadow-md transition-all duration-300 h-full">
                            {product.image && (
                    ...
                    {/* CTA to optimize products */}
                    <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                      <p className="text-sm text-gray-700 mb-3">
                        <strong>Want to optimize these products for SEO?</strong> Sign up for free to access AI-powered product description generation and schema markup.
                      </p>
                      <Link
                        href="/login"
        ...
        {!auditReport && !loading && (
          <div className="px-6 py-16">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Ready to audit your site</h3>
              <p className="text-gray-600 mb-8">Enter your website URL above to scan for technical SEO issues</p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                <Card className="p-6 border-2 border-gray-200">
                  <h4 className="font-bold text-gray-900 mb-3">What Gets Checked</h4>
              ...
              <div className="mt-10 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-200">
                <h4 className="text-lg font-bold text-gray-900 mb-2">Want More SEO Tools?</h4>
                <p className="text-sm text-gray-600 mb-4">
                  Sign up for free to access AI content optimization, schema generation, keyword research, and more.
                </p>
                <Link
                  href="/login"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-xl transition-all shadow-md"
                >
                  Sign Up Free
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
      ...
      <footer className="mt-16 py-8 border-t border-gray-200 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} Serchify. Free SEO tools for e-commerce businesses.</p>
        </div>
      </footer>
    </div>
  )
